...
// spin up instance of app and return address 'http://localhost:XXXX'
async fn spawn_app() -> TestApp {
    ...
    let server = zero2prod::startup::run(listen, connection_pool.clone()).expect("Failed to bind address");
